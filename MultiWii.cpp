...
void setup() {
  ...
  #if defined(IR_SENSORS)
    pinMode(IR_FRONT_L, INPUT);
    pinMode(IR_FRONT_R, INPUT);
    pinMode(IR_LEFT_F, INPUT);
    pinMode(IR_LEFT_B, INPUT);
    pinMode(IR_RIGHT_F, INPUT);
    pinMode(IR_RIGHT_B, INPUT);
    pinMode(IR_BACK_L, INPUT);
    pinMode(IR_BACK_R, INPUT);
  #endif
}
